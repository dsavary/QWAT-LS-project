@echo on
SET NOM_PROJET=QWAT_LAUSANNE_SCHEMATIQUE_PROD
rem call "\\geodata.lausanne.ch\data\QGIS_projet\eauservice\qwat_lausanne\config_qgis\0_copy_parametres.bat" %NOM_PROJET%
...
rem set QGIS_UDIR=%USERPROFILE%\.qgis2qwat
echo %OSGEO4W_ROOT%
rem echo %QGIS_UDIR%
start "QGIS" /B "%OSGEO4W_ROOT%"\bin\qgis-bin.exe %USERPROFILE%\QGIS\%NOM_PROJET%.qgs
