@echo on
SET NOM_PROJET=qwat_lausanne3d_saisie_218_formation
call "\\geodata.lausanne.ch\data\QGIS_projet\eauservice\qwat_lausanne\config_qgis\0_copy_parametres.bat" %NOM_PROJET%
