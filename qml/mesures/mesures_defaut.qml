  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{3f6973bd-4e94-4558-84ce-24673fa9a8c9}">
      ...
      <rule filter=" &quot;usr_fk_table&quot; =  5 " key="{7ae1a350-e079-454f-9c56-0ac88c960b46}" label="Points de constructions">
        <rule filter=" &quot;code&quot; IN ('4212','4220','4221','4222','4223','4224','4225','4227','4228','4229')" key="{ffe43f56-6233-42b5-9538-d17ba75c2522}" symbol="1" label="Points de constructions"/>
        <rule filter=" &quot;code&quot; IN ( '4286','4287')" key="{ec557671-a1a4-4639-9807-afc64210f595}" symbol="2" label="Points de constructions = BH"/>
        <rule filter=" &quot;code&quot; IN ('4260', '4261')" key="{53ece52b-9187-47cf-b0bc-13a10913accb}" symbol="3" label="Points de constructions = Introduction bâtiment"/>
        <rule filter=" &quot;code&quot; ='4250'" key="{18004664-90ab-4bc1-8494-e14c7dfc020f}" symbol="4" label="Points de constructions = Vanne existante"/>
        <rule filter=" &quot;code&quot; = '4343'" key="{886bd79e-0f1d-4138-a261-a47d55073e13}" symbol="5" label="Point de construction = Couvercle d'ouvrage"/>
        <rule filter=" &quot;code&quot; = '4300'" key="{e855137c-f303-4a57-b0ca-5a55727e92f9}" symbol="6" label="Point de construction = Corps de chambre d'ouvrage"/>
      </rule>
    </rules>
    <symbols>
