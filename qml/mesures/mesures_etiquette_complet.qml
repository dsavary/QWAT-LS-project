...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1501" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{3f6973bd-4e94-4558-84ce-24673fa9a8c9}">
      ...
      <rule filter=" &quot;usr_fk_table&quot; =  5 " key="{7ae1a350-e079-454f-9c56-0ac88c960b46}" label="Points de constructions">
        <rule filter=" &quot;code&quot; IN ('4212','4220','4221','4222','4223','4224','4225','4227','4228','4229')" key="{65ba9e28-5677-4163-86fe-84c75a30f2cb}" symbol="1" label="Points de constructions"/>
        <rule filter=" &quot;code&quot; IN ( '4286','4287')" key="{7719fec5-3192-4946-99b0-a87b8cbab715}" symbol="2" label="Points de constructions = BH"/>
        <rule filter=" &quot;code&quot; IN ('4260', '4261')" key="{a1aa1954-745f-4a0c-98b9-c55554616854}" symbol="3" label="Points de constructions = Introduction bâtiment"/>
        <rule filter=" &quot;code&quot; ='4250'" key="{7324ce16-3944-4d9d-a374-b02c5770578b}" symbol="4" label="Points de constructions = Vanne existante"/>
        <rule filter=" &quot;code&quot; = '4343'" key="{eb8ae632-fd30-4745-ab89-21cb31590edf}" symbol="5" label="Point de construction = Couvercle d'ouvrage"/>
        <rule filter=" &quot;code&quot; = '4300'" key="{21bf0ab5-2850-4424-9747-53a193a384d2}" symbol="6" label="Point de construction = Corps de chambre d'ouvrage"/>
      </rule>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="'N° point : ' ||   coalesce(  &quot;usr_no_pt&quot; , '')   ||  '\n'   || &#xd;&#xa;'N° station : '||   coalesce(   &quot;usr_no_station_ref&quot;  ,'')   || '\n'  || &#xd;&#xa;'Altitude : ' ||   coalesce(   z(  $geometry )  , '')   || '\n'   || &#xd;&#xa;'Niveau : '  ||  coalesce(  &quot;Niveau_value_fr&quot;   , '')   || '\n'  || &#xd;&#xa;'Date de saisie : '  ||  coalesce(    &quot;date&quot;   , '')   || '\n'  || &#xd;&#xa;'Type d''objet : '  ||  coalesce(  &quot;doctables_name_fr&quot;   , '')   || '\n'  || &#xd;&#xa;'N° job : '  ||  coalesce(  &quot;usr_session_name&quot; ,'')  ||  '\n' "/>
