...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="5001" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="id">
      <widgetv2config IsMultiline="0" fieldEditable="0" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="RelationReference" name="fk_installation_building">
      <widgetv2config OrderByValue="0" fieldEditable="1" AllowAddFeatures="0" ShowForm="0" Relation="relation_installation_building_details" ReadOnly="1" constraint="" MapIdentification="1" labelOnTop="0" constraintDescription="" notNull="0" AllowNULL="1"/>
    </edittype>
    <edittype widgetv2type="ValueRelation" name="fk_type">
      <widgetv2config OrderByValue="0" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="id" constraint="" Layer="installation_building_type_detail20171005215420471" Value="value_fr" labelOnTop="0" constraintDescription="" AllowMulti="0" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="fk_installation_building" index="1" name="Ouvrage de référence"/>
    <alias field="fk_type" index="2" name="Genre"/>
    <alias field="remark" index="3" name="Remarque"/>
    <alias field="dim_length" index="4" name="Rayon"/>
    <alias field="dim_width" index="5" name="Largeur"/>
    <alias field="create_date" index="6" name=""/>
    <alias field="last_date" index="7" name=""/>
    <alias field="last_user" index="8" name=""/>
    <alias field="deleted" index="9" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="fk_installation_building"/>
...
⇥control = dialog.findChild(QWidget, "MyLineEdit")
  ...
  <defaults>
    ...
    <default field="fk_installation_building" expression=""/>
