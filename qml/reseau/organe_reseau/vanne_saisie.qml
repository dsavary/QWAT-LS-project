...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1001" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{85e48cc6-eedf-47a7-a3f2-5fbd85f1eb84}">
      <rule filter=" &quot;fk_status&quot; = 1301" key="{c9e2aaed-74b7-4578-be20-a4db5b69b746}" label="En service">
        <rule filter=" &quot;appel_fk_function&quot; = 102" key="{1ef243a8-6eeb-4c5c-9c8a-db5a5c75839d}" symbol="0" label="Inconnu"/>
        <rule filter=" &quot;appel_fk_function&quot;   = 6101" key="{d3d79f9f-1366-4a16-9e08-513d1802298e}" symbol="1" label="Vanne de régulation (clayton)"/>
        <rule filter=" &quot;appel_fk_function&quot;  = 6102" key="{55f30e47-9578-4060-8945-b8dba852cd8e}" symbol="2" label="Sortie d'air automatique"/>
        <rule filter=" &quot;appel_fk_function&quot; = 6103" key="{afae49b2-910f-4e60-b9bf-c6aa5f532cca}" symbol="3" label="Vanne de by-pass"/>
        <rule filter=" &quot;appel_fk_function&quot; = 6105" key="{ccad6d08-89e6-4229-bc11-d79b6ca001ad}" label="Vanne branchement">
          <rule filter=" &quot;appel_fk_type&quot;  IN (102,63005, 63006,63007,63008,63009,63010)" key="{59caa36b-21c4-47c7-9171-26056e15cbb4}" symbol="4" label="Vanne"/>
          <rule filter=" &quot;appel_fk_type&quot;  IN (6311,63011,63012)" key="{37584549-c162-4118-a545-95a1c7f87633}" symbol="5" label="Vanne papillon"/>
          <rule filter="&quot;appel_fk_type&quot; IN (63001,63002,63003)" key="{62af8a31-0e30-4ce4-ae5d-4329d30aaa7a}" symbol="6" label="Robinet"/>
        </rule>
        <rule description="Vanne d'hydrante" filter=" &quot;appel_fk_function&quot; = 6108" key="{bb28d934-7d4f-4001-a752-021156730953}" symbol="7" label="Vanne hydrante"/>
        <rule description="Vanne de purge (vidange)" filter=" &quot;appel_fk_function&quot; = 6110" key="{bee52a86-c6c4-450b-aa8a-f6aaa4d81ffd}" symbol="8" label="Vanne de purge (vidange)"/>
        <rule description="Vanne d'hydrante >2011" filter=" &quot;appel_fk_function&quot; = 6111" key="{9fbacd38-8a3e-4807-8a48-fbe3fbad6d60}" label="Vanne réseau">
          <rule description="Vanne d'hydrante >2011" filter=" &quot;appel_fk_type&quot; NOT IN (6311,63011,63012)" key="{ec6ec48b-c94a-4d2b-bdfe-0b9d3dba3dfa}" symbol="9" label="Vanne"/>
          <rule description="Vanne d'hydrante >2011" filter=" &quot;appel_fk_type&quot;  IN (6311,63011,63012)" key="{2275efb5-b5a7-40b6-9aa2-508c3681f83c}" symbol="10" label="Vanne papillon"/>
        </rule>
        <rule description="Sortie d'air manuelle" filter=" &quot;appel_fk_function&quot; = 6112" key="{9e0fbd67-0afd-4b63-9aba-380c971814dc}" symbol="11" label="Sortie d'air manuelle"/>
        <rule filter=" &quot;appel_fk_function&quot; = 6113" key="{27430d08-8deb-478d-afa7-3d5c480e5100}" symbol="12" label="Vanne antiretour"/>
        <rule filter=" &quot;appel_fk_function&quot;  is null OR  &quot;appel_fk_function&quot; = 103" key="{44a2ebbf-6483-4fca-8508-16cb181be2b6}" symbol="13" label="Defaut"/>
        <rule filter="&quot;closed&quot; = 't' AND  &quot;appel_fk_function&quot; NOT IN (6102,6103,6112)" key="{31b293f9-478d-47e3-aab0-a40bf28335e9}" symbol="14" label="Vanne fermée"/>
      </rule>
      <rule description="Vanne nouveau relevé" filter=" &quot;fk_status&quot;  =  103 " key="{79173b18-03ce-49fe-8b3f-287303b25fb7}" symbol="15" label="Nouveau relevé"/>
      <rule filter="&quot;fk_status&quot; NOT IN (103,1301,13002) OR  &quot;fk_status&quot; is null" key="{f8edf00a-1f64-4a20-ba84-3c9b32b1a2a5}" symbol="16" label="Defaut"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{df3bfd0a-ec96-4d27-ac4d-62394259c196}">
      <rule scalemaxdenom="51" description="Etiquette des vannes en service" filter=" &quot;fk_status&quot; = 1301" key="{f317906f-25c0-4929-8d9a-cda633e1202d}" scalemindenom="1">
        <settings>
