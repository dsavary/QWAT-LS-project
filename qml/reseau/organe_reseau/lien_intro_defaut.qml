...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="2001" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueRelation" name="fk_status">
      <widgetv2config OrderByValue="0" AllowNull="0" FilterExpression=" &quot;vl_active&quot;  =  't' " UseCompleter="0" fieldEditable="0" Key="id" constraint="" Layer="vl_status20130304110011436" Value="value_fr" labelOnTop="0" constraintDescription="" AllowMulti="0" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="ArrowLine" locked="0">
          <prop k="arrow_start_width" v="0.1"/>
  ...
  <aliases>
    <alias field="id" index="0" name="ID intro"/>
    <alias field="fk_status" index="1" name="Statut"/>
    <alias field="length" index="2" name="Longueur"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="COALESCE( &quot;length&quot;, '&lt;NULL>' )" sortOrder="0">
    <columns>
